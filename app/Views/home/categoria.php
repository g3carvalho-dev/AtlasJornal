...
?>
            <li><a href="<?= url('/categoria/' . urlencode($valor)) ;?>"
                    class="<?= $categoriaAtual === $valor ? 'active' : '' ;?>"><?= $label ;?></a></li>
            <?php endforeach; ?>
        </ul>
    </nav>
    ...
    <main class="secao" style="padding: 40px 5%; min-height: 60vh;">
        ...
        <div class="category-header"
            style="border-bottom: 3px solid var(--azul); margin-bottom: 30px; padding-bottom: 10px;">
            <span style="font-size: 0.9rem; color: var(--dourado); font-weight: 600; letter-spacing: 2px;">PROCURANDO
                POR:</span>
            <h2
                style="margin: 5px 0 0 0; font-size: 2.5rem; font-family: 'Playfair Display', serif; color: var(--azul); text-transform: uppercase;">
                <?= e($categoriaAtual) ;?>
            </h2>
        </div>
        ...
        <div class="card" style="padding: 50px; text-align: center; max-width: 500px; margin: 0 auto;">
            <i class="fa-regular fa-newspaper"
                style="font-size: 40px; color: var(--dourado); margin-bottom: 15px; display: block;"></i>
