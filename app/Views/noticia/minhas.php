    ...
    <section class="secao" style="margin-top:30px;">
        ...
        <?php if (empty($noticias)): ?>
            <div class="card" style="padding:40px; max-width:600px; margin:0 auto; text-align:center;">
                ...
                <a href="<?= url('/noticia/nova') ;?>" class="btn-enviar" style="text-decoration:none; display:inline-flex; padding:12px 24px; border-radius:8px;">
                    <i class="fa-solid fa-plus"></i> Criar Primeira Notícia
                </a>
            </div>
        <?php else: ?>
            <div class="cards">
